  ...
  return (
    <main className="game-shell">
      ...
      <footer className="dispatch-bar">
        ...
        <button type="button" className="dispatch-button" onClick={() => void dispatch()} disabled={!stateLoaded || isDispatching || gameState.completed}>{isDispatching ? 'RUNNING…' : isRunComplete ? 'RUN COMPLETE' : 'DISPATCH'} <span>→</span></button>
